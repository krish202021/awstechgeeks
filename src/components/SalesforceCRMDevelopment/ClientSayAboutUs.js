        ...
        <div className="container">
          <div className="crumina-module crumina-heading">
            <h2 className="heading-title">
              What our Clients <span className="c-primary">say about us?</span>
            </h2>
          </div>
          <div className="row">
                      ...
                      <div className="swiper-container" data-effect="fade">
                        <div className="swiper-wrapper">
                          <div className="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
                            <div
                              className="testimonial-img-author"
                            ...
                            >
                              It was fantastic 7 years working with Jamal and
                              Team. I didn't even realize, we spent more than 7
                              years together. Timezone Difference or Remote work
                              was never a barrier. I highly recommend them.
                            </h6>

                            <div
                              className="author-info-wrap"
                              data-swiper-parallax="-100"
                            >
                          ...
                          <div className="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
                            ...
                            >
                              ...
                              time easily accessible, cost-effective and
                          ...
                          <div className="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
                            ...
                            >
                              ...
                              excellent IT Offshore Partner. We were looking for
                              a Company which can take care of our 30+ existing
                              websites and can also develop new websites.
                            </h6>
