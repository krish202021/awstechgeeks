...
function HelpYou() {
  return (
    <div>
        <section class="background-cover align-center medium-padding120 web-app cont-sec digita-contact-box web-app-dev scss-serve-sec">
		<div class="container">
			<div class="bg-96">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						{/* <a href="#" class="btn btn-primary btn-market btn--with-shadow js-message-popup let-talk-btn">
							Contact Now
						</a> */}
