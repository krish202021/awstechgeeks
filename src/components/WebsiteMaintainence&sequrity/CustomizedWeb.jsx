                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="crumina-module ">
                                <div className="img-thumb">
                                    <img src="img/Website-Maintenance-Security-img.png" alt="app-developmen" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9 col-md-12 col-12 col-xxl-9">
                            <div className="crumina-module">
                                <h2 className="heading-title">Why to pay monthly subscription charges?</h2>
                                <h2 className="heading-title">Get a web application developed to manage <br /> your Business operations 100%.</h2>

                                <Link to='/popup' className="btn btn-small btn--icon-right btn-border btn--with-shadow c-primary js-message-popup">
                                    <div className="text">
                                        <span className="title">DROP A MESSAGE NOW</span>
                                    </div>
                                </Link>
                            </div>
